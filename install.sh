...
requests.post("http://supervisor/homeassistant/api/states/ups.power", headers=headers, json={"state": round(batt_power / 1000, 2), "attributes": {"unit_of_measurement": "W", "icon": "mdi:lightning-bolt", "friendly_name": "Battery power"}})
